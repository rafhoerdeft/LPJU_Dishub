                ...
                <div class="card-group">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-vlc text-info"></i></h2>
                                    <h3 class=""><?= $jml_pj ?></h3>
                                    <h6 class="card-subtitle">Jumlah Perlengkapan Jalan</h6></div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h3 class=""><?= $jml_pju ?></h3>
                                    <h6 class="card-subtitle">Jumlah Penerangan Jalan</h6></div>
                                <div class="col-12">
                                    <div class="progress">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-verified text-success"></i></h2>
                                    <h3 class=""><?= $jml_pj_baik ?></h3>
                                    <h6 class="card-subtitle">Jumlah Perlengkapan Baik</h6></div>
                                <div class="col-12">
                                    <div class="progress">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="m-b-0"><i class="mdi mdi-alert-octagon text-danger"></i></h2>
                                    <h3 class=""><?= $jml_pj_rusak ?></h3>
                                    <h6 class="card-subtitle">Jumlah Perlengkapan Rusak</h6></div>
                                <div class="col-12">
                                    <div class="progress">
