                    ...
                    <div class="card-body">
                    	<div class="row">
	                    	...
	                    	<div class="col-md-2 d-block d-sm-block d-md-block d-lg-none m-b-5">
		                    	<button type="button" class="btn btn-block btn-info waves-effect"  title="View" onclick="viewPJ()"><i class="fa fa-eye"></i> View</button>
		                    	<button type="button" class="btn btn-block btn-success waves-effect"  title="Cetak Excel" onclick="exportPj()"><i class="mdi mdi-file-excel"></i> Export</button>                  	
		                    </div>

		                    <div class="col-md-2 d-none d-sm-none d-md-none d-lg-block text-center m-b-5">
		                    	<button type="button" class="btn btn-info waves-effect"  title="View" onclick="viewPJ()"><i class="fa fa-eye"></i></button>
		                    	<button type="button" class="btn btn-success waves-effect"  title="Cetak Excel" onclick="exportPj()"><i class="mdi mdi-file-excel"></i></button>
		                    </div>

	                    	<!-- <button type="button" class="btn btn-info waves-effect"  title="View" onclick="viewPJ()"><i class="fa fa-eye"></i></button> -->
	                    	<!-- &nbsp; -->
	                    	<!-- <button type="button" class="btn btn-success waves-effect"  title="Cetak Excel"><i class="mdi mdi-file-excel"></i></button> -->
	                    </div>
	                </div>
                </div>
                                    ...
                                    ?>
                                            <tr style="font-size: 10pt">
                                                ...
                                                <?php if ($idSelectPj == '1') { ?>
                                                    ...
                                                    <td align="center"><?= $pj->meteran_listrik ?></td>
