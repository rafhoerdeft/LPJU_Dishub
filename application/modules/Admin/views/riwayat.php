            ...
            <div class="row page-titles">
                ...
                <div class="col-md-6 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('Admin/perlengkapanJalan/').encode($id_jenis_pj);?>">Perlengkapan Jalan</a></li>
            ...
            <div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="addRiwayat" method="post" action="<?=base_url();?>Admin/simpanRiwayat">
            ...
            <div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="addRiwayat" method="post" action="<?=base_url();?>Admin/updateRiwayat">
        ...
        <script type="text/javascript">
            ...
            function deleteRiwayat(id_jenis_pj, id_pj, id_riwayat){
                swal({
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo base_url('Admin/deleteRiwayat')?>",
                        dataType : "html",
                        data : {
            ...
            function showModalEdit(id_riwayat){
                ...
                $.post("<?= base_url().'Admin/getDataRiwayat' ?>", {id_riwayat:id_riwayat}, function(result){
