        ...
        <div class="page-wrapper">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-8 m-b-10">
                                <?php if (decode($this->uri->segment(3))=='1' || $this->uri->segment(3)=='') {?>
                                    <select id="jenisListrik" class="form-control select2" onchange="changeJenisListrik();" style="width: 100%;">
                                        <option value="<?=encode('all')?>">Semua</option>
                                        <?php foreach ($listrik as $row) { 
                                            if ($row->nama_pj=='Abonemen') {?>
                                                <option value="<?=encode($row->id_pj)?>" <?=($row->id_pj == decode($this->uri->segment(4))?'selected':'')?> ><?= $row->nama_pj?></option>
                                            <?php } else {?>
                                                <option value="<?=encode($row->id_pj)?>" <?=($row->id_pj == decode($this->uri->segment(4))?'selected':'')?> ><?= $row->nama_pj.' ['.$row->no_id_pel.'] ['.$row->nama_jalan ?>]</option>
                                        <?php } }?> 
                                    </select>
                                <?php } ?>
                            </div>
                                            ...
                                            ?>
                                                    <tr style="font-size: 9pt">
                                                        ...
                                                        <?php } else if ($idSelectPj == '7') {?>
                                                            ...
                                                            <td align="center"><?= $pj->no_id_pel ?></td>
                                                            <td align="center"><?= $pj->panjang_tarikan_meterisasi ?></td>
                                                        <?php } ?>
                                                        
                                                        <td align="center"><?= $pj->kondisi_pj ?></td>
                                                        <td align="center">
                                                            <?php  
                                                                if ($pj->foto_pj!='' || $pj->foto_pj!=null) {
                                                        ...
                                                        <td width="125">
                                                            <a style="width: 30px" href="<?=base_url('Admin/riwayatPj/').encode($pj->id_pj).'/'.encode($idSelectPj);?>" class="btn btn-sm waves-effect waves-light btn-success m-b-5"  title="Riwayat Perbaikan"><i class="fa fa-history"></i></a>
            ...
            <div id="modal-edit" class="modal fade" role="dialog" aria-labelledby="myModalLabels" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <form id="updatePj" method="POST" action="<?= base_url().'Admin/updatePj' ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select id="abonemen" class="form-control" name="abonemen" data-validation-required-message="Abonemen harus diisi">
                                ...
                                <?php } else if ($idSelectPj == 7) {?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="pelanggan" class="control-label">No ID Pelanggan:</label><br>
                                                <div class="controls">
                                                    <input required data-validation-required-message="No id pelanggan harus diisi" type="text" class="form-control" name="no_id_pel" id="pelanggan">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="tarikan" class="control-label">Panjang Tarikan Meterisasi:</label><br>
                                                <div class="controls">
                                                    <input required data-validation-required-message="Panjang tarikan harus diisi" type="text" class="form-control" name="panjang_tarikan_meterisasi" id="tarikan">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="map-edit" style="height: 300px; width: 100%">
                                            <div style="z-index: 2; position: absolute; margin-top: 420px; margin-left: 12px;">
                                                <img src="<?= base_url().'assets/assets/images/logo/dishub-logo-sm.png' ?>" width='35'>
                                                <!-- <label>DISHUB</label> -->
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="latitude-edit" class="control-label">Latitude</label>
                                            <div class="controls">
                                                <input required data-validation-required-message="Latitude" type="text" class="form-control" name="latitude" id="latitude-edit">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="longitude-edit" class="control-label">Longitude</label>
                                            <div class="controls">
                                                <input required data-validation-required-message="Longitude" type="text" class="form-control" name="longitude" id="longitude-edit">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <script type="text/javascript">
                function changeJenisPj() {
                    ...
                    window.location = "<?= base_url().'Admin/perlengkapanJalan/' ?>" + id;
                }

                function changeJenisListrik(){
                    var id = $('#jenisPj option:selected').attr('value');
                    var listrik = $('#jenisListrik option:selected').attr('value');
                    window.location = "<?= base_url().'Admin/perlengkapanJalan/' ?>" + id +'/'+ listrik;
                }
            ...
            <script type="text/javascript">
                ...
                function showModalEdit(id_jenis_pj='', id_pj='') {
                    ...
                    $.post("<?= base_url().'Admin/getDataEditPj' ?>", {id_jenis_pj:id_jenis_pj, id_pj:id_pj}, function(result){
                        ...
                        if (dt.response) {
                            for (var i = 0; i < dt.data.length; i++) {
                                ...
                                if (id_jenis_pj == '1') {
                                    ...
                                    $('#modal-edit #pelanggan').val(dt.data[i].no_id_pel);
                                    $('#modal-edit #tarikan').val(dt.data[i].panjang_tarikan_meterisasi);
                                }
                                
                                var lati = parseFloat(dt.data[i].latitude);
                                var long = parseFloat(dt.data[i].longitude);

                                console.log(lati+' '+long);

                                $('#latitude-edit').val(lati);
                                $('#longitude-edit').val(long);
                                initMapEdit(lati,long);
            ...
            <script>
                ...
                function initMapEdit(lati,long) {
                  // The location of Magelang
                  var potitionPJ = new google.maps.LatLng(lati, long);
                  ...
                  var map = new google.maps.Map(
                      document.getElementById('map-edit'), mapOptions);
