                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img width="40" src="<?= base_url() ?>assets/assets/images/logo/dishub-logo-sm.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                        ...
                        <!-- Logo text -->
                        <span>
                            <label style="font-size: 18pt; color: grey"><b style="font-weight: bold; color: #1976d2">LPJU</b> APP</label>
                        </span> 
                    </a>
                </div>
                <!-- ============================================================== -->
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?//= base_url() ?>assets/assets/images/users/1.jpg" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
